...
async function initDatabase() {
  try {
    ...
    await run(`CREATE INDEX IF NOT EXISTS idx_inventory_variants_item_id ON inventory_variants(item_id)`);
    await run(`CREATE INDEX IF NOT EXISTS idx_inventory_assignments_variant_id ON inventory_assignments(variant_id)`);
    await run(`CREATE INDEX IF NOT EXISTS idx_inventory_assignments_staff_id ON inventory_assignments(staff_id)`);
    await run(`CREATE INDEX IF NOT EXISTS idx_inventory_assignments_status ON inventory_assignments(status)`);
